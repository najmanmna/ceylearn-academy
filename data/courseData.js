export const allCourses = [
  {
    ...
    longDescription: "This comprehensive 8-week diploma covers everything you need to become a job-ready digital marketer. We dive deep into SEO, paid advertising, content marketing, and analytics, focusing on hands-on projects you can add to your portfolio.",
    duration: "8 Weeks",
    level: "Intermediate",
    whatYouWillLearn: [
  ...
  },
  {
    ...
    longDescription: "Our 6-week certificate program teaches you the fundamental principles of graphic design. You'll work with industry-standard tools like Adobe Photoshop, Illustrator, and Figma to create 5 real-world projects.",
    duration: "6 Weeks",
    level: "Beginner",
    whatYouWillLearn: [
  ...
  },
  {
    ...
    longDescription: "This 4-week course unlocks the power of your phone's camera. We'll cover composition, lighting, editing apps, and how to create stunning images for social media or personal projects.",
    duration: "4 Weeks",
    level: "Beginner",
    whatYouWillLearn: [
  ...
  },
  {
    ...
    longDescription: "Become an office superstar. This 3-week certificate focuses on the essential skills in Microsoft Office. You'll learn to create professional documents, build insightful spreadsheets, and deliver engaging presentations.",
    duration: "3 Weeks",
    level: "All Levels",
    whatYouWillLearn: [
  ...
  },
  {
    ...
    summary: "Go beyond design. Learn to create visuals that solve business problems and drive campaigns.",
    cardImage: "/images/courses/graphic-adv-card.jpg",

    // --- (Schema 2) Data for Course Page ---
    headerImage: "/images/courses/graphic-adv-header.jpg",
    longDescription: "This advanced 12-week diploma bridges the gap between design and marketing. You'll master Adobe Creative Suite, but also learn campaign strategy, copywriting, and how to create cohesive advertising materials from print to digital.",
    duration: "12 Weeks",
    level: "Intermediate",
    whatYouWillLearn: [
  ...
  },
  {
    ...
    summary: "Master the art of traditional and modern henna design, from cone preparation to client work.",
    cardImage: "/images/courses/mehandi-card.jpg",

    // --- (Schema 2) Data for Course Page ---
    headerImage: "/images/courses/mehandi-header.jpg",
    longDescription: "Turn your passion for henna into a profession. This 5-week course covers everything from making the perfect henna paste to mastering intricate bridal designs and simple, modern motifs.",
    duration: "5 Weeks",
    level: "Beginner",
    whatYouWillLearn: [
  ...
  },
  {
    ...
    summary: "Learn to design, craft, and manage stunning events, from custom decor to flawless execution.",
    cardImage: "/images/courses/event-planning-card.jpg",

    // --- (Schema 2) Data for Course Page ---
    headerImage: "/images/courses/event-planning-header.jpg",
    longDescription: "This 6-week course combines creativity with logistics. You'll learn to plan events like weddings and parties, and also how to create the custom craft elements (like centerpieces and backdrops) that make them unique.",
    duration: "6 Weeks",
    level: "All Levels",
    whatYouWillLearn: [
  ...
  },
  {
    ...
    summary: "Become a professional makeup artist specializing in bridal and special occasion looks.",
    cardImage: "/images/courses/bridal-makeup-card.jpg",

    // --- (Schema 2) Data for Course Page ---
    headerImage: "/images/courses/bridal-makeup-header.jpg",
    longDescription: "This intensive 4-week course provides hands-on training in bridal makeup. You'll learn skin prep, color matching, and techniques for creating flawless, long-lasting looks for brides and bridal parties.",
    duration: "4 Weeks",
    level: "Beginner",
    whatYouWillLearn: [
  ...
  },
  {
    ...
    summary: "An advanced diploma exploring complex henna designs and the art of mixing 'jagua' and other mediums.",
    cardImage: "/images/courses/henna-mixology-card.jpg",

    // --- (Schema 2) Data for Course Page ---
    headerImage: "/images/courses/henna-mixology-header.jpg",
    longDescription: "Go beyond basic henna. This 8-week diploma is for artists who want to stand out. We explore 'jagua' henna for realistic tattoo-like designs, white henna, glitter, and advanced mixology techniques to create unique, signature styles.",
    duration: "8 Weeks",
    level: "Intermediate",
    whatYouWillLearn: [
  ...
  },
  {
    ...
    summary: "From baking fundamentals to advanced sugarcraft, become a professional cake artist.",
    cardImage: "/images/courses/cake-diploma-card.jpg",

    // --- (Schema 2) Data for Course Page ---
    headerImage: "/images/courses/cake-diploma-header.jpg",
    longDescription: "This 10-week diploma is a complete guide to professional cake artistry. You'll learn baking science, how to make various icings, and master decoration techniques from simple piping to complex sugar flowers and tiered wedding cakes.",
    duration: "10 Weeks",
    level: "All Levels",
    whatYouWillLearn: [
